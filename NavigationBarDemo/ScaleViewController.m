...
@property (nonatomic, strong) UIImageView * topImageView; //titleView
...
//        self.automaticallyAdjustsScrollViewInsets = NO;
    ...
    UIBarButtonItem * rightBtn =[[UIBarButtonItem alloc] initWithTitle:@"滚动变换" style:UIBarButtonItemStyleDone target:self action:@selector(goTransparentPage:)];
...
{
    TransparentViewController * transVC = [[TransparentViewController alloc] init];
    transVC.alphaBlock = ^(CGFloat alpha){
        _receiveAlpha = alpha;
    };
...
{
    HiddenNavigationBarViewController *hiddenVC = [[HiddenNavigationBarViewController alloc] init];
