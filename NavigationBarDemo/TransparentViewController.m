...
@interface TransparentViewController ()<UITableViewDataSource, UITableViewDelegate>
...
{
    _topImageView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, kScreenWidth, kScreenWidth*435.5/414.0)];
...
- (void)createHeadView
{
    ...
    UIView * headBkView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, kScreenWidth, _topContentInset)];
    ...
    _headImageView.center = CGPointMake(kScreenWidth/2., (_topContentInset - 64)/2.);
